...
from Registration.models import UserProfileInfo, Staffdetails,Admin
...
class AdmindetailsForm(forms.ModelForm):
    ...
    class Meta():
        model = Admin
        fields = ('Name','username','email', 'password1', 'password2', 'canteen_name', 'canteen_street', 'canteen_city','canteen_pincode')
